...
export default function CreateAccessTokenForm({
  ...
  const copyToClipboard = async (text: string) => {
    ...
    Alert.alert(t('accessTokens.form.copied'), t('accessTokens.form.tokenCopied'));
  };
    ...
    <ThemedView style={styles.container}>
      {showTitle && (
        <View style={styles.header}>
          ...
          />
          <ThemedText style={styles.title}>{t('accessTokens.form.title')}</ThemedText>
      ...
      <ThemedView style={[
        ...
        <View style={styles.inputGroup}>
          <ThemedText style={styles.inputLabel}>{t('accessTokens.form.tokenName')}</ThemedText>
          <TextInput
            style={[
              styles.input,
              { 
        ...
        <View style={styles.inputGroup}>
          <ThemedText style={styles.inputLabel}>{t('accessTokens.form.expiration')}</ThemedText>
          <TextInput
            style={[
              styles.input,
              { 
        ...
        <View style={styles.buttonRow}>
          ...
          >
            <ThemedText style={styles.createButtonText}>
              {creating ? t('accessTokens.form.creating') : t('accessTokens.form.createButton')}
            </ThemedText>
          </TouchableOpacity>
          ...
          <ThemedView style={styles.tokenModalContainer}>
            <View style={styles.tokenModalHeader}>
              <Ionicons 
                ...
                color={Colors[colorScheme ?? 'light'].tint} 
              />
              <ThemedText style={styles.tokenModalTitle}>{t('accessTokens.form.tokenCreatedTitle')}</ThemedText>
            ...
            <View style={[
              ...
              <TouchableOpacity
                style={[styles.copyButton, { backgroundColor: Colors[colorScheme ?? 'light'].tint }]}
                onPress={() => copyToClipboard(newToken)}
              >
                <Ionicons name="copy" size={20} color="white" />
                <Text style={styles.copyButtonText}>{t('accessTokens.form.copy')}</Text>
              </TouchableOpacity>
            </View>
            ...
            >
              <ThemedText style={styles.doneButtonText}>{t('accessTokens.form.done')}</ThemedText>
            </TouchableOpacity>
          </ThemedView>
        </View>
      </Modal>
