...
interface NotificationsListRQProps {
  /**
   * Optional bucket ID to filter notifications
   * If provided, only notifications from this bucket will be shown
   */
  bucketId?: string;

  /**
   * Hide bucket information in notification items
   */
...
export default function NotificationsListRQ({
  bucketId,
