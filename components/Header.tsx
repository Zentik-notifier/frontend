...
const ROUTE_TITLES: Partial<Record<string, TranslationKeyPath>> = {
  ...
  "/(mobile)/(admin)/server-files": "administration.serverFiles.title" as any,
  "/(tablet)/(admin)/server-files": "administration.serverFiles.title" as any,
