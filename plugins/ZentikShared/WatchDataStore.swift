...
class WatchDataStore {
    ...
    // Keep filesystem writes sparse to reduce wear and battery usage.
    // Increased intervals for better battery life on Watch.
    private let persistDebounceInterval: TimeInterval = 10.0
    private let minPersistInterval: TimeInterval = 60.0
