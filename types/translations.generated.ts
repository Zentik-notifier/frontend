...
export interface Translation {
  ...
  cachedData: {
    ...
    notificationsInCache: string;
    deleteAll: string;
    import: string;
    clearAll: string;
    noNotifications: string;
    bucketsInCache: string;
    noBuckets: string;
    logs: string;
    entriesInLocalStorage: string;
    logFiles: string;
    noLogEntries: string;
    unknownSize: string;
    noLogFiles: string;
    noEntriesInFile: string;
    appSettings: string;
    settingsInStorage: string;
    ...
    noMediaMetadata: string;
    bucketDetails: string;
    logEntryDetails: string;
