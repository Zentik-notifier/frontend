...
export type GetMeQuery = { __typename?: 'Query', me: { __typename?: 'User', id: string, email: string, username: string, firstName: string | null, lastName: string | null, avatar: string | null, hasPassword: boolean, role: UserRole, createdAt: string, updatedAt: string, devices: Array<{ __typename?: 'UserDevice', id: string, platform: string, deviceName: string | null, deviceModel: string | null, osVersion: string | null, onlyLocal: boolean, lastUsed: string, createdAt: string, updatedAt: string, deviceToken: string | null, publicKey: string | null, privateKey: string | null }> | null, buckets: Array<{ __typename?: 'Bucket', id: string, name: string, description: string | null, icon: string | null, color: string | null, createdAt: string, updatedAt: string }> | null } };
...
export type OAuthProviderPublicFragment = { __typename?: 'OAuthProviderPublicDto', id: string, name: string, type: OAuthProviderType, iconUrl: string | null, color: string | null, textColor: string | null };
...
export type GetSystemAccessTokensQuery = { __typename?: 'Query', listSystemTokens: Array<{ __typename?: 'SystemAccessTokenDto', id: string, maxCalls: number, calls: number, totalCalls: number, expiresAt: string | null, lastResetAt: string | null, description: string | null, scopes: Array<string> | null, token: string | null, createdAt: string, updatedAt: string, requester: { __typename?: 'User', id: string, username: string, email: string, firstName: string | null, lastName: string | null } | null }> };
...
export type GetSystemTokenQuery = { __typename?: 'Query', getSystemToken: { __typename?: 'SystemAccessTokenDto', id: string, maxCalls: number, calls: number, totalCalls: number, expiresAt: string | null, lastResetAt: string | null, description: string | null, scopes: Array<string> | null, token: string | null, createdAt: string, updatedAt: string, requester: { __typename?: 'User', id: string, username: string, email: string, firstName: string | null, lastName: string | null } | null } | null };
...
export type CreateSystemAccessTokenMutation = { __typename?: 'Mutation', createSystemToken: { __typename?: 'SystemAccessTokenDto', rawToken: string | null, id: string, maxCalls: number, calls: number, totalCalls: number, expiresAt: string | null, lastResetAt: string | null, description: string | null, scopes: Array<string> | null, token: string | null, createdAt: string, updatedAt: string, requester: { __typename?: 'User', id: string, username: string, email: string, firstName: string | null, lastName: string | null } | null } };
