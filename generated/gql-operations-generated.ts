...
export type Bucket = {
  ...
  externalNotifySystem: Maybe<ExternalNotifySystem>;
  externalSystemChannel: Maybe<Scalars['String']['output']>;
...
export type CreateExternalNotifySystemDto = {
...
export type Mutation = {
  ...
  createExternalNotifySystem: ExternalNotifySystem;
  ...
  deleteExternalNotifySystem: Scalars['Boolean']['output'];
  ...
  deleteWatchToken: Scalars['Boolean']['output'];
...
export type MutationCreateExternalNotifySystemArgs = {
...
export type MutationDeleteExternalNotifySystemArgs = {
  id: Scalars['ID']['input'];
};
...
export type MutationShareExternalNotifySystemArgs = {
  input: GrantEntityPermissionInput;
};
...
export type MutationUnshareExternalNotifySystemArgs = {
  input: RevokeEntityPermissionInput;
};
...
export type MutationUpdateExternalNotifySystemArgs = {
  id: Scalars['ID']['input'];
...
export type Query = {
  ...
  externalNotifySystemPermissions: Array<EntityPermission>;
  externalNotifySystems: Array<ExternalNotifySystem>;
  ...
  getWatchToken: Maybe<AccessTokenListDto>;
...
export type QueryExternalNotifySystemArgs = {
  id: Scalars['ID']['input'];
};


export type QueryExternalNotifySystemPermissionsArgs = {
  resourceId: Scalars['String']['input'];
};
...
export type ResourcePermissionsDto = {
  __typename?: 'ResourcePermissionsDto';
...
export enum ResourceType {
  Bucket = 'BUCKET',
  ExternalNotifySystem = 'EXTERNAL_NOTIFY_SYSTEM',
...
export type UpdateExternalNotifySystemDto = {
  authPassword?: InputMaybe<Scalars['String']['input']>;
  authToken?: InputMaybe<Scalars['String']['input']>;
  authUser?: InputMaybe<Scalars['String']['input']>;
  ...
  iconUrl?: InputMaybe<Scalars['String']['input']>;
  name?: InputMaybe<Scalars['String']['input']>;
  type?: InputMaybe<ExternalNotifySystemType>;
};
...
export type User = {
  ...
  externalNotifySystems: Maybe<Array<ExternalNotifySystem>>;
...
export type ExternalNotifySystemFragment = { __typename?: 'ExternalNotifySystem', id: string, name: string, baseUrl: string, type: ExternalNotifySystemType, iconUrl: string | null, color: string | null, createdAt: string, updatedAt: string, user: { __typename?: 'User', id: string, username: string }, userPermissions: { __typename?: 'ResourcePermissionsDto', canRead: boolean, canWrite: boolean, canDelete: boolean, canAdmin: boolean, isOwner: boolean, isSharedWithMe: boolean, sharedCount: number } };

export type GetExternalNotifySystemsQueryVariables = Exact<{ [key: string]: never; }>;


export type GetExternalNotifySystemsQuery = { __typename?: 'Query', externalNotifySystems: Array<{ __typename?: 'ExternalNotifySystem', id: string, name: string, baseUrl: string, type: ExternalNotifySystemType, iconUrl: string | null, color: string | null, createdAt: string, updatedAt: string, user: { __typename?: 'User', id: string, username: string }, userPermissions: { __typename?: 'ResourcePermissionsDto', canRead: boolean, canWrite: boolean, canDelete: boolean, canAdmin: boolean, isOwner: boolean, isSharedWithMe: boolean, sharedCount: number } }> };

export type GetExternalNotifySystemQueryVariables = Exact<{
  id: Scalars['ID']['input'];
}>;


export type GetExternalNotifySystemQuery = { __typename?: 'Query', externalNotifySystem: { __typename?: 'ExternalNotifySystem', id: string, name: string, baseUrl: string, type: ExternalNotifySystemType, iconUrl: string | null, color: string | null, createdAt: string, updatedAt: string, user: { __typename?: 'User', id: string, username: string }, userPermissions: { __typename?: 'ResourcePermissionsDto', canRead: boolean, canWrite: boolean, canDelete: boolean, canAdmin: boolean, isOwner: boolean, isSharedWithMe: boolean, sharedCount: number } } };

export type CreateExternalNotifySystemMutationVariables = Exact<{
  input: CreateExternalNotifySystemDto;
}>;


export type CreateExternalNotifySystemMutation = { __typename?: 'Mutation', createExternalNotifySystem: { __typename?: 'ExternalNotifySystem', id: string, name: string, baseUrl: string, type: ExternalNotifySystemType, iconUrl: string | null, color: string | null, createdAt: string, updatedAt: string, user: { __typename?: 'User', id: string, username: string }, userPermissions: { __typename?: 'ResourcePermissionsDto', canRead: boolean, canWrite: boolean, canDelete: boolean, canAdmin: boolean, isOwner: boolean, isSharedWithMe: boolean, sharedCount: number } } };

export type UpdateExternalNotifySystemMutationVariables = Exact<{
  id: Scalars['ID']['input'];
  input: UpdateExternalNotifySystemDto;
}>;


export type UpdateExternalNotifySystemMutation = { __typename?: 'Mutation', updateExternalNotifySystem: { __typename?: 'ExternalNotifySystem', id: string, name: string, baseUrl: string, type: ExternalNotifySystemType, iconUrl: string | null, color: string | null, createdAt: string, updatedAt: string, user: { __typename?: 'User', id: string, username: string }, userPermissions: { __typename?: 'ResourcePermissionsDto', canRead: boolean, canWrite: boolean, canDelete: boolean, canAdmin: boolean, isOwner: boolean, isSharedWithMe: boolean, sharedCount: number } } };

export type DeleteExternalNotifySystemMutationVariables = Exact<{
  id: Scalars['ID']['input'];
}>;


export type DeleteExternalNotifySystemMutation = { __typename?: 'Mutation', deleteExternalNotifySystem: boolean };

export type ShareExternalNotifySystemMutationVariables = Exact<{
  input: GrantEntityPermissionInput;
}>;


export type ShareExternalNotifySystemMutation = { __typename?: 'Mutation', shareExternalNotifySystem: { __typename?: 'EntityPermission', id: string, resourceType: string, resourceId: string, permissions: Array<Permission>, expiresAt: string | null, createdAt: string, updatedAt: string, inviteCodeId: string | null, user: { __typename?: 'User', id: string, email: string, username: string, firstName: string | null, lastName: string | null, avatar: string | null, hasPassword: boolean, role: UserRole, createdAt: string, updatedAt: string, identities: Array<{ __typename?: 'UserIdentity', id: string, email: string | null, providerType: OAuthProviderType | null, metadata: string | null, createdAt: string }> | null, buckets: Array<{ __typename?: 'Bucket', id: string, name: string, description: string | null, icon: string | null, color: string | null, createdAt: string, updatedAt: string }> | null, devices: Array<{ __typename?: 'UserDevice', id: string, platform: string, deviceName: string | null, deviceModel: string | null, osVersion: string | null, onlyLocal: boolean, lastUsed: string, createdAt: string, updatedAt: string, metadata: string | null }> | null }, grantedBy: { __typename?: 'User', id: string, email: string, username: string, firstName: string | null, lastName: string | null, avatar: string | null, hasPassword: boolean, role: UserRole, createdAt: string, updatedAt: string, identities: Array<{ __typename?: 'UserIdentity', id: string, email: string | null, providerType: OAuthProviderType | null, metadata: string | null, createdAt: string }> | null, buckets: Array<{ __typename?: 'Bucket', id: string, name: string, description: string | null, icon: string | null, color: string | null, createdAt: string, updatedAt: string }> | null, devices: Array<{ __typename?: 'UserDevice', id: string, platform: string, deviceName: string | null, deviceModel: string | null, osVersion: string | null, onlyLocal: boolean, lastUsed: string, createdAt: string, updatedAt: string, metadata: string | null }> | null } | null } };

export type UnshareExternalNotifySystemMutationVariables = Exact<{
  input: RevokeEntityPermissionInput;
}>;


export type UnshareExternalNotifySystemMutation = { __typename?: 'Mutation', unshareExternalNotifySystem: boolean };
...
export type CreateOrRegenerateWatchTokenMutationVariables = Exact<{ [key: string]: never; }>;


export type CreateOrRegenerateWatchTokenMutation = { __typename?: 'Mutation', createOrRegenerateWatchToken: { __typename?: 'AccessTokenResponseDto', id: string, name: string, token: string, expiresAt: string | null, createdAt: string, tokenStored: boolean } };

export type GetWatchTokenQueryVariables = Exact<{ [key: string]: never; }>;


export type GetWatchTokenQuery = { __typename?: 'Query', getWatchToken: { __typename?: 'AccessTokenListDto', id: string, name: string, expiresAt: string | null, createdAt: string, lastUsed: string | null, isExpired: boolean, token: string | null, scopes: Array<string> | null } | null };

export type DeleteWatchTokenMutationVariables = Exact<{ [key: string]: never; }>;


export type DeleteWatchTokenMutation = { __typename?: 'Mutation', deleteWatchToken: boolean };
...
export const ExternalNotifySystemFragmentDoc = {"kind":"Document","definitions":[{"kind":"FragmentDefinition","name":{"kind":"Name","value":"ExternalNotifySystemFragment"},"typeCondition":{"kind":"NamedType","name":{"kind":"Name","value":"ExternalNotifySystem"}},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"name"}},{"kind":"Field","name":{"kind":"Name","value":"baseUrl"}},{"kind":"Field","name":{"kind":"Name","value":"type"}},{"kind":"Field","name":{"kind":"Name","value":"iconUrl"}},{"kind":"Field","name":{"kind":"Name","value":"color"}},{"kind":"Field","name":{"kind":"Name","value":"createdAt"}},{"kind":"Field","name":{"kind":"Name","value":"updatedAt"}},{"kind":"Field","name":{"kind":"Name","value":"user"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"username"}}]}},{"kind":"Field","name":{"kind":"Name","value":"userPermissions"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"canRead"}},{"kind":"Field","name":{"kind":"Name","value":"canWrite"}},{"kind":"Field","name":{"kind":"Name","value":"canDelete"}},{"kind":"Field","name":{"kind":"Name","value":"canAdmin"}},{"kind":"Field","name":{"kind":"Name","value":"isOwner"}},{"kind":"Field","name":{"kind":"Name","value":"isSharedWithMe"}},{"kind":"Field","name":{"kind":"Name","value":"sharedCount"}}]}}]}}]} as unknown as DocumentNode;
...
// @ts-ignore
export function useGetMyIdentitiesSuspenseQuery(baseOptions?: ApolloReactHooks.SuspenseQueryHookOptions<GetMyIdentitiesQuery, GetMyIdentitiesQueryVariables>): ApolloReactHooks.UseSuspenseQueryResult<GetMyIdentitiesQuery, GetMyIdentitiesQueryVariables>;
export function useGetMyIdentitiesSuspenseQuery(baseOptions?: ApolloReactHooks.SkipToken | ApolloReactHooks.SuspenseQueryHookOptions<GetMyIdentitiesQuery, GetMyIdentitiesQueryVariables>): ApolloReactHooks.UseSuspenseQueryResult<GetMyIdentitiesQuery | undefined, GetMyIdentitiesQueryVariables>;
...
// @ts-ignore
export function useGetNotificationSuspenseQuery(baseOptions?: ApolloReactHooks.SuspenseQueryHookOptions<GetNotificationQuery, GetNotificationQueryVariables>): ApolloReactHooks.UseSuspenseQueryResult<GetNotificationQuery, GetNotificationQueryVariables>;
export function useGetNotificationSuspenseQuery(baseOptions?: ApolloReactHooks.SkipToken | ApolloReactHooks.SuspenseQueryHookOptions<GetNotificationQuery, GetNotificationQueryVariables>): ApolloReactHooks.UseSuspenseQueryResult<GetNotificationQuery | undefined, GetNotificationQueryVariables>;
...
// @ts-ignore
export function useChangelogsForModalSuspenseQuery(baseOptions?: ApolloReactHooks.SuspenseQueryHookOptions<ChangelogsForModalQuery, ChangelogsForModalQueryVariables>): ApolloReactHooks.UseSuspenseQueryResult<ChangelogsForModalQuery, ChangelogsForModalQueryVariables>;
export function useChangelogsForModalSuspenseQuery(baseOptions?: ApolloReactHooks.SkipToken | ApolloReactHooks.SuspenseQueryHookOptions<ChangelogsForModalQuery, ChangelogsForModalQueryVariables>): ApolloReactHooks.UseSuspenseQueryResult<ChangelogsForModalQuery | undefined, ChangelogsForModalQueryVariables>;
...
// @ts-ignore
export function useAdminChangelogsSuspenseQuery(baseOptions?: ApolloReactHooks.SuspenseQueryHookOptions<AdminChangelogsQuery, AdminChangelogsQueryVariables>): ApolloReactHooks.UseSuspenseQueryResult<AdminChangelogsQuery, AdminChangelogsQueryVariables>;
export function useAdminChangelogsSuspenseQuery(baseOptions?: ApolloReactHooks.SkipToken | ApolloReactHooks.SuspenseQueryHookOptions<AdminChangelogsQuery, AdminChangelogsQueryVariables>): ApolloReactHooks.UseSuspenseQueryResult<AdminChangelogsQuery | undefined, AdminChangelogsQueryVariables>;
...
// @ts-ignore
export function useChangelogSuspenseQuery(baseOptions?: ApolloReactHooks.SuspenseQueryHookOptions<ChangelogQuery, ChangelogQueryVariables>): ApolloReactHooks.UseSuspenseQueryResult<ChangelogQuery, ChangelogQueryVariables>;
export function useChangelogSuspenseQuery(baseOptions?: ApolloReactHooks.SkipToken | ApolloReactHooks.SuspenseQueryHookOptions<ChangelogQuery, ChangelogQueryVariables>): ApolloReactHooks.UseSuspenseQueryResult<ChangelogQuery | undefined, ChangelogQueryVariables>;
...
// @ts-ignore
export function useScheduledMessagesForCurrentUserSuspenseQuery(baseOptions?: ApolloReactHooks.SuspenseQueryHookOptions<ScheduledMessagesForCurrentUserQuery, ScheduledMessagesForCurrentUserQueryVariables>): ApolloReactHooks.UseSuspenseQueryResult<ScheduledMessagesForCurrentUserQuery, ScheduledMessagesForCurrentUserQueryVariables>;
export function useScheduledMessagesForCurrentUserSuspenseQuery(baseOptions?: ApolloReactHooks.SkipToken | ApolloReactHooks.SuspenseQueryHookOptions<ScheduledMessagesForCurrentUserQuery, ScheduledMessagesForCurrentUserQueryVariables>): ApolloReactHooks.UseSuspenseQueryResult<ScheduledMessagesForCurrentUserQuery | undefined, ScheduledMessagesForCurrentUserQueryVariables>;
...
// @ts-ignore
export function useMessageRemindersForCurrentUserSuspenseQuery(baseOptions?: ApolloReactHooks.SuspenseQueryHookOptions<MessageRemindersForCurrentUserQuery, MessageRemindersForCurrentUserQueryVariables>): ApolloReactHooks.UseSuspenseQueryResult<MessageRemindersForCurrentUserQuery, MessageRemindersForCurrentUserQueryVariables>;
export function useMessageRemindersForCurrentUserSuspenseQuery(baseOptions?: ApolloReactHooks.SkipToken | ApolloReactHooks.SuspenseQueryHookOptions<MessageRemindersForCurrentUserQuery, MessageRemindersForCurrentUserQueryVariables>): ApolloReactHooks.UseSuspenseQueryResult<MessageRemindersForCurrentUserQuery | undefined, MessageRemindersForCurrentUserQueryVariables>;
...
// @ts-ignore
export function usePendingPostponesSuspenseQuery(baseOptions?: ApolloReactHooks.SuspenseQueryHookOptions<PendingPostponesQuery, PendingPostponesQueryVariables>): ApolloReactHooks.UseSuspenseQueryResult<PendingPostponesQuery, PendingPostponesQueryVariables>;
export function usePendingPostponesSuspenseQuery(baseOptions?: ApolloReactHooks.SkipToken | ApolloReactHooks.SuspenseQueryHookOptions<PendingPostponesQuery, PendingPostponesQueryVariables>): ApolloReactHooks.UseSuspenseQueryResult<PendingPostponesQuery | undefined, PendingPostponesQueryVariables>;
...
// @ts-ignore
export function useGetBucketsSuspenseQuery(baseOptions?: ApolloReactHooks.SuspenseQueryHookOptions<GetBucketsQuery, GetBucketsQueryVariables>): ApolloReactHooks.UseSuspenseQueryResult<GetBucketsQuery, GetBucketsQueryVariables>;
export function useGetBucketsSuspenseQuery(baseOptions?: ApolloReactHooks.SkipToken | ApolloReactHooks.SuspenseQueryHookOptions<GetBucketsQuery, GetBucketsQueryVariables>): ApolloReactHooks.UseSuspenseQueryResult<GetBucketsQuery | undefined, GetBucketsQueryVariables>;
...
// @ts-ignore
export function useGetBucketSuspenseQuery(baseOptions?: ApolloReactHooks.SuspenseQueryHookOptions<GetBucketQuery, GetBucketQueryVariables>): ApolloReactHooks.UseSuspenseQueryResult<GetBucketQuery, GetBucketQueryVariables>;
export function useGetBucketSuspenseQuery(baseOptions?: ApolloReactHooks.SkipToken | ApolloReactHooks.SuspenseQueryHookOptions<GetBucketQuery, GetBucketQueryVariables>): ApolloReactHooks.UseSuspenseQueryResult<GetBucketQuery | undefined, GetBucketQueryVariables>;
...
// @ts-ignore
export function useBucketPermissionsSuspenseQuery(baseOptions?: ApolloReactHooks.SuspenseQueryHookOptions<BucketPermissionsQuery, BucketPermissionsQueryVariables>): ApolloReactHooks.UseSuspenseQueryResult<BucketPermissionsQuery, BucketPermissionsQueryVariables>;
export function useBucketPermissionsSuspenseQuery(baseOptions?: ApolloReactHooks.SkipToken | ApolloReactHooks.SuspenseQueryHookOptions<BucketPermissionsQuery, BucketPermissionsQueryVariables>): ApolloReactHooks.UseSuspenseQueryResult<BucketPermissionsQuery | undefined, BucketPermissionsQueryVariables>;
...
// @ts-ignore
export function useInviteCodesForResourceSuspenseQuery(baseOptions?: ApolloReactHooks.SuspenseQueryHookOptions<InviteCodesForResourceQuery, InviteCodesForResourceQueryVariables>): ApolloReactHooks.UseSuspenseQueryResult<InviteCodesForResourceQuery, InviteCodesForResourceQueryVariables>;
export function useInviteCodesForResourceSuspenseQuery(baseOptions?: ApolloReactHooks.SkipToken | ApolloReactHooks.SuspenseQueryHookOptions<InviteCodesForResourceQuery, InviteCodesForResourceQueryVariables>): ApolloReactHooks.UseSuspenseQueryResult<InviteCodesForResourceQuery | undefined, InviteCodesForResourceQueryVariables>;
...
// @ts-ignore
export function useGetUserSettingsSuspenseQuery(baseOptions?: ApolloReactHooks.SuspenseQueryHookOptions<GetUserSettingsQuery, GetUserSettingsQueryVariables>): ApolloReactHooks.UseSuspenseQueryResult<GetUserSettingsQuery, GetUserSettingsQueryVariables>;
export function useGetUserSettingsSuspenseQuery(baseOptions?: ApolloReactHooks.SkipToken | ApolloReactHooks.SuspenseQueryHookOptions<GetUserSettingsQuery, GetUserSettingsQueryVariables>): ApolloReactHooks.UseSuspenseQueryResult<GetUserSettingsQuery | undefined, GetUserSettingsQueryVariables>;
...
// @ts-ignore
export function useGetUserDevicesSuspenseQuery(baseOptions?: ApolloReactHooks.SuspenseQueryHookOptions<GetUserDevicesQuery, GetUserDevicesQueryVariables>): ApolloReactHooks.UseSuspenseQueryResult<GetUserDevicesQuery, GetUserDevicesQueryVariables>;
export function useGetUserDevicesSuspenseQuery(baseOptions?: ApolloReactHooks.SkipToken | ApolloReactHooks.SuspenseQueryHookOptions<GetUserDevicesQuery, GetUserDevicesQueryVariables>): ApolloReactHooks.UseSuspenseQueryResult<GetUserDevicesQuery | undefined, GetUserDevicesQueryVariables>;
...
// @ts-ignore
export function useGetUserDeviceSuspenseQuery(baseOptions?: ApolloReactHooks.SuspenseQueryHookOptions<GetUserDeviceQuery, GetUserDeviceQueryVariables>): ApolloReactHooks.UseSuspenseQueryResult<GetUserDeviceQuery, GetUserDeviceQueryVariables>;
export function useGetUserDeviceSuspenseQuery(baseOptions?: ApolloReactHooks.SkipToken | ApolloReactHooks.SuspenseQueryHookOptions<GetUserDeviceQuery, GetUserDeviceQueryVariables>): ApolloReactHooks.UseSuspenseQueryResult<GetUserDeviceQuery | undefined, GetUserDeviceQueryVariables>;
...
// @ts-ignore
export function useGetUserWebhooksSuspenseQuery(baseOptions?: ApolloReactHooks.SuspenseQueryHookOptions<GetUserWebhooksQuery, GetUserWebhooksQueryVariables>): ApolloReactHooks.UseSuspenseQueryResult<GetUserWebhooksQuery, GetUserWebhooksQueryVariables>;
export function useGetUserWebhooksSuspenseQuery(baseOptions?: ApolloReactHooks.SkipToken | ApolloReactHooks.SuspenseQueryHookOptions<GetUserWebhooksQuery, GetUserWebhooksQueryVariables>): ApolloReactHooks.UseSuspenseQueryResult<GetUserWebhooksQuery | undefined, GetUserWebhooksQueryVariables>;
...
// @ts-ignore
export function useGetWebhookSuspenseQuery(baseOptions?: ApolloReactHooks.SuspenseQueryHookOptions<GetWebhookQuery, GetWebhookQueryVariables>): ApolloReactHooks.UseSuspenseQueryResult<GetWebhookQuery, GetWebhookQueryVariables>;
export function useGetWebhookSuspenseQuery(baseOptions?: ApolloReactHooks.SkipToken | ApolloReactHooks.SuspenseQueryHookOptions<GetWebhookQuery, GetWebhookQueryVariables>): ApolloReactHooks.UseSuspenseQueryResult<GetWebhookQuery | undefined, GetWebhookQueryVariables>;
...
export const GetExternalNotifySystemsDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"query","name":{"kind":"Name","value":"GetExternalNotifySystems"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"externalNotifySystems"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"FragmentSpread","name":{"kind":"Name","value":"ExternalNotifySystemFragment"}}]}}]}},{"kind":"FragmentDefinition","name":{"kind":"Name","value":"ExternalNotifySystemFragment"},"typeCondition":{"kind":"NamedType","name":{"kind":"Name","value":"ExternalNotifySystem"}},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"name"}},{"kind":"Field","name":{"kind":"Name","value":"baseUrl"}},{"kind":"Field","name":{"kind":"Name","value":"type"}},{"kind":"Field","name":{"kind":"Name","value":"iconUrl"}},{"kind":"Field","name":{"kind":"Name","value":"color"}},{"kind":"Field","name":{"kind":"Name","value":"createdAt"}},{"kind":"Field","name":{"kind":"Name","value":"updatedAt"}},{"kind":"Field","name":{"kind":"Name","value":"user"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"username"}}]}},{"kind":"Field","name":{"kind":"Name","value":"userPermissions"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"canRead"}},{"kind":"Field","name":{"kind":"Name","value":"canWrite"}},{"kind":"Field","name":{"kind":"Name","value":"canDelete"}},{"kind":"Field","name":{"kind":"Name","value":"canAdmin"}},{"kind":"Field","name":{"kind":"Name","value":"isOwner"}},{"kind":"Field","name":{"kind":"Name","value":"isSharedWithMe"}},{"kind":"Field","name":{"kind":"Name","value":"sharedCount"}}]}}]}}]} as unknown as DocumentNode;

/**
 * __useGetExternalNotifySystemsQuery__
 *
 * To run a query within a React component, call `useGetExternalNotifySystemsQuery` and pass it any options that fit your needs.
 * When your component renders, `useGetExternalNotifySystemsQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useGetExternalNotifySystemsQuery({
 *   variables: {
 *   },
 * });
 */
export function useGetExternalNotifySystemsQuery(baseOptions?: ApolloReactHooks.QueryHookOptions<GetExternalNotifySystemsQuery, GetExternalNotifySystemsQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return ApolloReactHooks.useQuery<GetExternalNotifySystemsQuery, GetExternalNotifySystemsQueryVariables>(GetExternalNotifySystemsDocument, options);
      }
export function useGetExternalNotifySystemsLazyQuery(baseOptions?: ApolloReactHooks.LazyQueryHookOptions<GetExternalNotifySystemsQuery, GetExternalNotifySystemsQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return ApolloReactHooks.useLazyQuery<GetExternalNotifySystemsQuery, GetExternalNotifySystemsQueryVariables>(GetExternalNotifySystemsDocument, options);
        }
// @ts-ignore
export function useGetExternalNotifySystemsSuspenseQuery(baseOptions?: ApolloReactHooks.SuspenseQueryHookOptions<GetExternalNotifySystemsQuery, GetExternalNotifySystemsQueryVariables>): ApolloReactHooks.UseSuspenseQueryResult<GetExternalNotifySystemsQuery, GetExternalNotifySystemsQueryVariables>;
export function useGetExternalNotifySystemsSuspenseQuery(baseOptions?: ApolloReactHooks.SkipToken | ApolloReactHooks.SuspenseQueryHookOptions<GetExternalNotifySystemsQuery, GetExternalNotifySystemsQueryVariables>): ApolloReactHooks.UseSuspenseQueryResult<GetExternalNotifySystemsQuery | undefined, GetExternalNotifySystemsQueryVariables>;
export function useGetExternalNotifySystemsSuspenseQuery(baseOptions?: ApolloReactHooks.SkipToken | ApolloReactHooks.SuspenseQueryHookOptions<GetExternalNotifySystemsQuery, GetExternalNotifySystemsQueryVariables>) {
          const options = baseOptions === ApolloReactHooks.skipToken ? baseOptions : {...defaultOptions, ...baseOptions}
          return ApolloReactHooks.useSuspenseQuery<GetExternalNotifySystemsQuery, GetExternalNotifySystemsQueryVariables>(GetExternalNotifySystemsDocument, options);
        }
export type GetExternalNotifySystemsQueryHookResult = ReturnType<typeof useGetExternalNotifySystemsQuery>;
export type GetExternalNotifySystemsLazyQueryHookResult = ReturnType<typeof useGetExternalNotifySystemsLazyQuery>;
export type GetExternalNotifySystemsSuspenseQueryHookResult = ReturnType<typeof useGetExternalNotifySystemsSuspenseQuery>;
export type GetExternalNotifySystemsQueryResult = Apollo.QueryResult<GetExternalNotifySystemsQuery, GetExternalNotifySystemsQueryVariables>;
export const GetExternalNotifySystemDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"query","name":{"kind":"Name","value":"GetExternalNotifySystem"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"id"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"ID"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"externalNotifySystem"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"id"},"value":{"kind":"Variable","name":{"kind":"Name","value":"id"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"FragmentSpread","name":{"kind":"Name","value":"ExternalNotifySystemFragment"}}]}}]}},{"kind":"FragmentDefinition","name":{"kind":"Name","value":"ExternalNotifySystemFragment"},"typeCondition":{"kind":"NamedType","name":{"kind":"Name","value":"ExternalNotifySystem"}},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"name"}},{"kind":"Field","name":{"kind":"Name","value":"baseUrl"}},{"kind":"Field","name":{"kind":"Name","value":"type"}},{"kind":"Field","name":{"kind":"Name","value":"iconUrl"}},{"kind":"Field","name":{"kind":"Name","value":"color"}},{"kind":"Field","name":{"kind":"Name","value":"createdAt"}},{"kind":"Field","name":{"kind":"Name","value":"updatedAt"}},{"kind":"Field","name":{"kind":"Name","value":"user"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"username"}}]}},{"kind":"Field","name":{"kind":"Name","value":"userPermissions"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"canRead"}},{"kind":"Field","name":{"kind":"Name","value":"canWrite"}},{"kind":"Field","name":{"kind":"Name","value":"canDelete"}},{"kind":"Field","name":{"kind":"Name","value":"canAdmin"}},{"kind":"Field","name":{"kind":"Name","value":"isOwner"}},{"kind":"Field","name":{"kind":"Name","value":"isSharedWithMe"}},{"kind":"Field","name":{"kind":"Name","value":"sharedCount"}}]}}]}}]} as unknown as DocumentNode;

/**
 * __useGetExternalNotifySystemQuery__
 *
 * To run a query within a React component, call `useGetExternalNotifySystemQuery` and pass it any options that fit your needs.
 * When your component renders, `useGetExternalNotifySystemQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useGetExternalNotifySystemQuery({
 *   variables: {
 *      id: // value for 'id'
 *   },
 * });
 */
export function useGetExternalNotifySystemQuery(baseOptions: ApolloReactHooks.QueryHookOptions<GetExternalNotifySystemQuery, GetExternalNotifySystemQueryVariables> & ({ variables: GetExternalNotifySystemQueryVariables; skip?: boolean; } | { skip: boolean; }) ) {
        const options = {...defaultOptions, ...baseOptions}
        return ApolloReactHooks.useQuery<GetExternalNotifySystemQuery, GetExternalNotifySystemQueryVariables>(GetExternalNotifySystemDocument, options);
      }
export function useGetExternalNotifySystemLazyQuery(baseOptions?: ApolloReactHooks.LazyQueryHookOptions<GetExternalNotifySystemQuery, GetExternalNotifySystemQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return ApolloReactHooks.useLazyQuery<GetExternalNotifySystemQuery, GetExternalNotifySystemQueryVariables>(GetExternalNotifySystemDocument, options);
        }
// @ts-ignore
export function useGetExternalNotifySystemSuspenseQuery(baseOptions?: ApolloReactHooks.SuspenseQueryHookOptions<GetExternalNotifySystemQuery, GetExternalNotifySystemQueryVariables>): ApolloReactHooks.UseSuspenseQueryResult<GetExternalNotifySystemQuery, GetExternalNotifySystemQueryVariables>;
export function useGetExternalNotifySystemSuspenseQuery(baseOptions?: ApolloReactHooks.SkipToken | ApolloReactHooks.SuspenseQueryHookOptions<GetExternalNotifySystemQuery, GetExternalNotifySystemQueryVariables>): ApolloReactHooks.UseSuspenseQueryResult<GetExternalNotifySystemQuery | undefined, GetExternalNotifySystemQueryVariables>;
export function useGetExternalNotifySystemSuspenseQuery(baseOptions?: ApolloReactHooks.SkipToken | ApolloReactHooks.SuspenseQueryHookOptions<GetExternalNotifySystemQuery, GetExternalNotifySystemQueryVariables>) {
          const options = baseOptions === ApolloReactHooks.skipToken ? baseOptions : {...defaultOptions, ...baseOptions}
          return ApolloReactHooks.useSuspenseQuery<GetExternalNotifySystemQuery, GetExternalNotifySystemQueryVariables>(GetExternalNotifySystemDocument, options);
        }
export type GetExternalNotifySystemQueryHookResult = ReturnType<typeof useGetExternalNotifySystemQuery>;
export type GetExternalNotifySystemLazyQueryHookResult = ReturnType<typeof useGetExternalNotifySystemLazyQuery>;
export type GetExternalNotifySystemSuspenseQueryHookResult = ReturnType<typeof useGetExternalNotifySystemSuspenseQuery>;
export type GetExternalNotifySystemQueryResult = Apollo.QueryResult<GetExternalNotifySystemQuery, GetExternalNotifySystemQueryVariables>;
export const CreateExternalNotifySystemDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"mutation","name":{"kind":"Name","value":"CreateExternalNotifySystem"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"input"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"CreateExternalNotifySystemDto"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"createExternalNotifySystem"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"input"},"value":{"kind":"Variable","name":{"kind":"Name","value":"input"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"FragmentSpread","name":{"kind":"Name","value":"ExternalNotifySystemFragment"}}]}}]}},{"kind":"FragmentDefinition","name":{"kind":"Name","value":"ExternalNotifySystemFragment"},"typeCondition":{"kind":"NamedType","name":{"kind":"Name","value":"ExternalNotifySystem"}},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"name"}},{"kind":"Field","name":{"kind":"Name","value":"baseUrl"}},{"kind":"Field","name":{"kind":"Name","value":"type"}},{"kind":"Field","name":{"kind":"Name","value":"iconUrl"}},{"kind":"Field","name":{"kind":"Name","value":"color"}},{"kind":"Field","name":{"kind":"Name","value":"createdAt"}},{"kind":"Field","name":{"kind":"Name","value":"updatedAt"}},{"kind":"Field","name":{"kind":"Name","value":"user"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"username"}}]}},{"kind":"Field","name":{"kind":"Name","value":"userPermissions"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"canRead"}},{"kind":"Field","name":{"kind":"Name","value":"canWrite"}},{"kind":"Field","name":{"kind":"Name","value":"canDelete"}},{"kind":"Field","name":{"kind":"Name","value":"canAdmin"}},{"kind":"Field","name":{"kind":"Name","value":"isOwner"}},{"kind":"Field","name":{"kind":"Name","value":"isSharedWithMe"}},{"kind":"Field","name":{"kind":"Name","value":"sharedCount"}}]}}]}}]} as unknown as DocumentNode;
export type CreateExternalNotifySystemMutationFn = Apollo.MutationFunction<CreateExternalNotifySystemMutation, CreateExternalNotifySystemMutationVariables>;

/**
 * __useCreateExternalNotifySystemMutation__
 *
 * To run a mutation, you first call `useCreateExternalNotifySystemMutation` within a React component and pass it any options that fit your needs.
 * When your component renders, `useCreateExternalNotifySystemMutation` returns a tuple that includes:
 * - A mutate function that you can call at any time to execute the mutation
 * - An object with fields that represent the current status of the mutation's execution
 *
 * @param baseOptions options that will be passed into the mutation, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options-2;
 *
 * @example
 * const [createExternalNotifySystemMutation, { data, loading, error }] = useCreateExternalNotifySystemMutation({
 *   variables: {
 *      input: // value for 'input'
 *   },
 * });
 */
export function useCreateExternalNotifySystemMutation(baseOptions?: ApolloReactHooks.MutationHookOptions<CreateExternalNotifySystemMutation, CreateExternalNotifySystemMutationVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return ApolloReactHooks.useMutation<CreateExternalNotifySystemMutation, CreateExternalNotifySystemMutationVariables>(CreateExternalNotifySystemDocument, options);
      }
export type CreateExternalNotifySystemMutationHookResult = ReturnType<typeof useCreateExternalNotifySystemMutation>;
export type CreateExternalNotifySystemMutationResult = Apollo.MutationResult<CreateExternalNotifySystemMutation>;
export type CreateExternalNotifySystemMutationOptions = Apollo.BaseMutationOptions<CreateExternalNotifySystemMutation, CreateExternalNotifySystemMutationVariables>;
export const UpdateExternalNotifySystemDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"mutation","name":{"kind":"Name","value":"UpdateExternalNotifySystem"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"id"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"ID"}}}},{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"input"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"UpdateExternalNotifySystemDto"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"updateExternalNotifySystem"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"id"},"value":{"kind":"Variable","name":{"kind":"Name","value":"id"}}},{"kind":"Argument","name":{"kind":"Name","value":"input"},"value":{"kind":"Variable","name":{"kind":"Name","value":"input"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"FragmentSpread","name":{"kind":"Name","value":"ExternalNotifySystemFragment"}}]}}]}},{"kind":"FragmentDefinition","name":{"kind":"Name","value":"ExternalNotifySystemFragment"},"typeCondition":{"kind":"NamedType","name":{"kind":"Name","value":"ExternalNotifySystem"}},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"name"}},{"kind":"Field","name":{"kind":"Name","value":"baseUrl"}},{"kind":"Field","name":{"kind":"Name","value":"type"}},{"kind":"Field","name":{"kind":"Name","value":"iconUrl"}},{"kind":"Field","name":{"kind":"Name","value":"color"}},{"kind":"Field","name":{"kind":"Name","value":"createdAt"}},{"kind":"Field","name":{"kind":"Name","value":"updatedAt"}},{"kind":"Field","name":{"kind":"Name","value":"user"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"username"}}]}},{"kind":"Field","name":{"kind":"Name","value":"userPermissions"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"canRead"}},{"kind":"Field","name":{"kind":"Name","value":"canWrite"}},{"kind":"Field","name":{"kind":"Name","value":"canDelete"}},{"kind":"Field","name":{"kind":"Name","value":"canAdmin"}},{"kind":"Field","name":{"kind":"Name","value":"isOwner"}},{"kind":"Field","name":{"kind":"Name","value":"isSharedWithMe"}},{"kind":"Field","name":{"kind":"Name","value":"sharedCount"}}]}}]}}]} as unknown as DocumentNode;
export type UpdateExternalNotifySystemMutationFn = Apollo.MutationFunction<UpdateExternalNotifySystemMutation, UpdateExternalNotifySystemMutationVariables>;

/**
 * __useUpdateExternalNotifySystemMutation__
 *
 * To run a mutation, you first call `useUpdateExternalNotifySystemMutation` within a React component and pass it any options that fit your needs.
 * When your component renders, `useUpdateExternalNotifySystemMutation` returns a tuple that includes:
 * - A mutate function that you can call at any time to execute the mutation
 * - An object with fields that represent the current status of the mutation's execution
 *
 * @param baseOptions options that will be passed into the mutation, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options-2;
 *
 * @example
 * const [updateExternalNotifySystemMutation, { data, loading, error }] = useUpdateExternalNotifySystemMutation({
 *   variables: {
 *      id: // value for 'id'
 *      input: // value for 'input'
 *   },
 * });
 */
export function useUpdateExternalNotifySystemMutation(baseOptions?: ApolloReactHooks.MutationHookOptions<UpdateExternalNotifySystemMutation, UpdateExternalNotifySystemMutationVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return ApolloReactHooks.useMutation<UpdateExternalNotifySystemMutation, UpdateExternalNotifySystemMutationVariables>(UpdateExternalNotifySystemDocument, options);
      }
export type UpdateExternalNotifySystemMutationHookResult = ReturnType<typeof useUpdateExternalNotifySystemMutation>;
export type UpdateExternalNotifySystemMutationResult = Apollo.MutationResult<UpdateExternalNotifySystemMutation>;
export type UpdateExternalNotifySystemMutationOptions = Apollo.BaseMutationOptions<UpdateExternalNotifySystemMutation, UpdateExternalNotifySystemMutationVariables>;
export const DeleteExternalNotifySystemDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"mutation","name":{"kind":"Name","value":"DeleteExternalNotifySystem"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"id"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"ID"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"deleteExternalNotifySystem"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"id"},"value":{"kind":"Variable","name":{"kind":"Name","value":"id"}}}]}]}}]} as unknown as DocumentNode;
export type DeleteExternalNotifySystemMutationFn = Apollo.MutationFunction<DeleteExternalNotifySystemMutation, DeleteExternalNotifySystemMutationVariables>;

/**
 * __useDeleteExternalNotifySystemMutation__
 *
 * To run a mutation, you first call `useDeleteExternalNotifySystemMutation` within a React component and pass it any options that fit your needs.
 * When your component renders, `useDeleteExternalNotifySystemMutation` returns a tuple that includes:
 * - A mutate function that you can call at any time to execute the mutation
 * - An object with fields that represent the current status of the mutation's execution
 *
 * @param baseOptions options that will be passed into the mutation, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options-2;
 *
 * @example
 * const [deleteExternalNotifySystemMutation, { data, loading, error }] = useDeleteExternalNotifySystemMutation({
 *   variables: {
 *      id: // value for 'id'
 *   },
 * });
 */
export function useDeleteExternalNotifySystemMutation(baseOptions?: ApolloReactHooks.MutationHookOptions<DeleteExternalNotifySystemMutation, DeleteExternalNotifySystemMutationVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return ApolloReactHooks.useMutation<DeleteExternalNotifySystemMutation, DeleteExternalNotifySystemMutationVariables>(DeleteExternalNotifySystemDocument, options);
      }
export type DeleteExternalNotifySystemMutationHookResult = ReturnType<typeof useDeleteExternalNotifySystemMutation>;
export type DeleteExternalNotifySystemMutationResult = Apollo.MutationResult<DeleteExternalNotifySystemMutation>;
export type DeleteExternalNotifySystemMutationOptions = Apollo.BaseMutationOptions<DeleteExternalNotifySystemMutation, DeleteExternalNotifySystemMutationVariables>;
export const ShareExternalNotifySystemDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"mutation","name":{"kind":"Name","value":"ShareExternalNotifySystem"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"input"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"GrantEntityPermissionInput"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"shareExternalNotifySystem"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"input"},"value":{"kind":"Variable","name":{"kind":"Name","value":"input"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"FragmentSpread","name":{"kind":"Name","value":"EntityPermissionFragment"}}]}}]}},{"kind":"FragmentDefinition","name":{"kind":"Name","value":"UserFragment"},"typeCondition":{"kind":"NamedType","name":{"kind":"Name","value":"User"}},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"email"}},{"kind":"Field","name":{"kind":"Name","value":"username"}},{"kind":"Field","name":{"kind":"Name","value":"firstName"}},{"kind":"Field","name":{"kind":"Name","value":"lastName"}},{"kind":"Field","name":{"kind":"Name","value":"avatar"}},{"kind":"Field","name":{"kind":"Name","value":"hasPassword"}},{"kind":"Field","name":{"kind":"Name","value":"role"}},{"kind":"Field","name":{"kind":"Name","value":"identities"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"email"}},{"kind":"Field","name":{"kind":"Name","value":"providerType"}},{"kind":"Field","name":{"kind":"Name","value":"metadata"}},{"kind":"Field","name":{"kind":"Name","value":"createdAt"}}]}},{"kind":"Field","name":{"kind":"Name","value":"buckets"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"name"}},{"kind":"Field","name":{"kind":"Name","value":"description"}},{"kind":"Field","name":{"kind":"Name","value":"icon"}},{"kind":"Field","name":{"kind":"Name","value":"color"}},{"kind":"Field","name":{"kind":"Name","value":"createdAt"}},{"kind":"Field","name":{"kind":"Name","value":"updatedAt"}}]}},{"kind":"Field","name":{"kind":"Name","value":"devices"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"platform"}},{"kind":"Field","name":{"kind":"Name","value":"deviceName"}},{"kind":"Field","name":{"kind":"Name","value":"deviceModel"}},{"kind":"Field","name":{"kind":"Name","value":"osVersion"}},{"kind":"Field","name":{"kind":"Name","value":"onlyLocal"}},{"kind":"Field","name":{"kind":"Name","value":"lastUsed"}},{"kind":"Field","name":{"kind":"Name","value":"createdAt"}},{"kind":"Field","name":{"kind":"Name","value":"updatedAt"}},{"kind":"Field","name":{"kind":"Name","value":"metadata"}}]}},{"kind":"Field","name":{"kind":"Name","value":"createdAt"}},{"kind":"Field","name":{"kind":"Name","value":"updatedAt"}}]}},{"kind":"FragmentDefinition","name":{"kind":"Name","value":"EntityPermissionFragment"},"typeCondition":{"kind":"NamedType","name":{"kind":"Name","value":"EntityPermission"}},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"resourceType"}},{"kind":"Field","name":{"kind":"Name","value":"resourceId"}},{"kind":"Field","name":{"kind":"Name","value":"permissions"}},{"kind":"Field","name":{"kind":"Name","value":"expiresAt"}},{"kind":"Field","name":{"kind":"Name","value":"createdAt"}},{"kind":"Field","name":{"kind":"Name","value":"updatedAt"}},{"kind":"Field","name":{"kind":"Name","value":"inviteCodeId"}},{"kind":"Field","name":{"kind":"Name","value":"user"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"FragmentSpread","name":{"kind":"Name","value":"UserFragment"}}]}},{"kind":"Field","name":{"kind":"Name","value":"grantedBy"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"FragmentSpread","name":{"kind":"Name","value":"UserFragment"}}]}}]}}]} as unknown as DocumentNode;
export type ShareExternalNotifySystemMutationFn = Apollo.MutationFunction<ShareExternalNotifySystemMutation, ShareExternalNotifySystemMutationVariables>;

/**
 * __useShareExternalNotifySystemMutation__
 *
 * To run a mutation, you first call `useShareExternalNotifySystemMutation` within a React component and pass it any options that fit your needs.
 * When your component renders, `useShareExternalNotifySystemMutation` returns a tuple that includes:
 * - A mutate function that you can call at any time to execute the mutation
 * - An object with fields that represent the current status of the mutation's execution
 *
 * @param baseOptions options that will be passed into the mutation, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options-2;
 *
 * @example
 * const [shareExternalNotifySystemMutation, { data, loading, error }] = useShareExternalNotifySystemMutation({
 *   variables: {
 *      input: // value for 'input'
 *   },
 * });
 */
export function useShareExternalNotifySystemMutation(baseOptions?: ApolloReactHooks.MutationHookOptions<ShareExternalNotifySystemMutation, ShareExternalNotifySystemMutationVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return ApolloReactHooks.useMutation<ShareExternalNotifySystemMutation, ShareExternalNotifySystemMutationVariables>(ShareExternalNotifySystemDocument, options);
      }
export type ShareExternalNotifySystemMutationHookResult = ReturnType<typeof useShareExternalNotifySystemMutation>;
export type ShareExternalNotifySystemMutationResult = Apollo.MutationResult<ShareExternalNotifySystemMutation>;
export type ShareExternalNotifySystemMutationOptions = Apollo.BaseMutationOptions<ShareExternalNotifySystemMutation, ShareExternalNotifySystemMutationVariables>;
export const UnshareExternalNotifySystemDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"mutation","name":{"kind":"Name","value":"UnshareExternalNotifySystem"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"input"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"RevokeEntityPermissionInput"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"unshareExternalNotifySystem"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"input"},"value":{"kind":"Variable","name":{"kind":"Name","value":"input"}}}]}]}}]} as unknown as DocumentNode;
export type UnshareExternalNotifySystemMutationFn = Apollo.MutationFunction<UnshareExternalNotifySystemMutation, UnshareExternalNotifySystemMutationVariables>;

/**
 * __useUnshareExternalNotifySystemMutation__
 *
 * To run a mutation, you first call `useUnshareExternalNotifySystemMutation` within a React component and pass it any options that fit your needs.
 * When your component renders, `useUnshareExternalNotifySystemMutation` returns a tuple that includes:
 * - A mutate function that you can call at any time to execute the mutation
 * - An object with fields that represent the current status of the mutation's execution
 *
 * @param baseOptions options that will be passed into the mutation, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options-2;
 *
 * @example
 * const [unshareExternalNotifySystemMutation, { data, loading, error }] = useUnshareExternalNotifySystemMutation({
 *   variables: {
 *      input: // value for 'input'
 *   },
 * });
 */
export function useUnshareExternalNotifySystemMutation(baseOptions?: ApolloReactHooks.MutationHookOptions<UnshareExternalNotifySystemMutation, UnshareExternalNotifySystemMutationVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return ApolloReactHooks.useMutation<UnshareExternalNotifySystemMutation, UnshareExternalNotifySystemMutationVariables>(UnshareExternalNotifySystemDocument, options);
      }
export type UnshareExternalNotifySystemMutationHookResult = ReturnType<typeof useUnshareExternalNotifySystemMutation>;
export type UnshareExternalNotifySystemMutationResult = Apollo.MutationResult<UnshareExternalNotifySystemMutation>;
export type UnshareExternalNotifySystemMutationOptions = Apollo.BaseMutationOptions<UnshareExternalNotifySystemMutation, UnshareExternalNotifySystemMutationVariables>;
...
// @ts-ignore
export function useGetUserAccessTokensSuspenseQuery(baseOptions?: ApolloReactHooks.SuspenseQueryHookOptions<GetUserAccessTokensQuery, GetUserAccessTokensQueryVariables>): ApolloReactHooks.UseSuspenseQueryResult<GetUserAccessTokensQuery, GetUserAccessTokensQueryVariables>;
export function useGetUserAccessTokensSuspenseQuery(baseOptions?: ApolloReactHooks.SkipToken | ApolloReactHooks.SuspenseQueryHookOptions<GetUserAccessTokensQuery, GetUserAccessTokensQueryVariables>): ApolloReactHooks.UseSuspenseQueryResult<GetUserAccessTokensQuery | undefined, GetUserAccessTokensQueryVariables>;
...
// @ts-ignore
export function useGetUserSessionsSuspenseQuery(baseOptions?: ApolloReactHooks.SuspenseQueryHookOptions<GetUserSessionsQuery, GetUserSessionsQueryVariables>): ApolloReactHooks.UseSuspenseQueryResult<GetUserSessionsQuery, GetUserSessionsQueryVariables>;
export function useGetUserSessionsSuspenseQuery(baseOptions?: ApolloReactHooks.SkipToken | ApolloReactHooks.SuspenseQueryHookOptions<GetUserSessionsQuery, GetUserSessionsQueryVariables>): ApolloReactHooks.UseSuspenseQueryResult<GetUserSessionsQuery | undefined, GetUserSessionsQueryVariables>;
...
// @ts-ignore
export function useGetAccessTokenSuspenseQuery(baseOptions?: ApolloReactHooks.SuspenseQueryHookOptions<GetAccessTokenQuery, GetAccessTokenQueryVariables>): ApolloReactHooks.UseSuspenseQueryResult<GetAccessTokenQuery, GetAccessTokenQueryVariables>;
export function useGetAccessTokenSuspenseQuery(baseOptions?: ApolloReactHooks.SkipToken | ApolloReactHooks.SuspenseQueryHookOptions<GetAccessTokenQuery, GetAccessTokenQueryVariables>): ApolloReactHooks.UseSuspenseQueryResult<GetAccessTokenQuery | undefined, GetAccessTokenQueryVariables>;
...
// @ts-ignore
export function useGetAccessTokensForBucketSuspenseQuery(baseOptions?: ApolloReactHooks.SuspenseQueryHookOptions<GetAccessTokensForBucketQuery, GetAccessTokensForBucketQueryVariables>): ApolloReactHooks.UseSuspenseQueryResult<GetAccessTokensForBucketQuery, GetAccessTokensForBucketQueryVariables>;
export function useGetAccessTokensForBucketSuspenseQuery(baseOptions?: ApolloReactHooks.SkipToken | ApolloReactHooks.SuspenseQueryHookOptions<GetAccessTokensForBucketQuery, GetAccessTokensForBucketQueryVariables>): ApolloReactHooks.UseSuspenseQueryResult<GetAccessTokensForBucketQuery | undefined, GetAccessTokensForBucketQueryVariables>;
...
export const CreateOrRegenerateWatchTokenDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"mutation","name":{"kind":"Name","value":"CreateOrRegenerateWatchToken"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"createOrRegenerateWatchToken"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"FragmentSpread","name":{"kind":"Name","value":"AccessTokenResponseFragment"}}]}}]}},{"kind":"FragmentDefinition","name":{"kind":"Name","value":"AccessTokenResponseFragment"},"typeCondition":{"kind":"NamedType","name":{"kind":"Name","value":"AccessTokenResponseDto"}},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"name"}},{"kind":"Field","name":{"kind":"Name","value":"token"}},{"kind":"Field","name":{"kind":"Name","value":"expiresAt"}},{"kind":"Field","name":{"kind":"Name","value":"createdAt"}},{"kind":"Field","name":{"kind":"Name","value":"tokenStored"}}]}}]} as unknown as DocumentNode;
export type CreateOrRegenerateWatchTokenMutationFn = Apollo.MutationFunction<CreateOrRegenerateWatchTokenMutation, CreateOrRegenerateWatchTokenMutationVariables>;

/**
 * __useCreateOrRegenerateWatchTokenMutation__
 *
 * To run a mutation, you first call `useCreateOrRegenerateWatchTokenMutation` within a React component and pass it any options that fit your needs.
 * When your component renders, `useCreateOrRegenerateWatchTokenMutation` returns a tuple that includes:
 * - A mutate function that you can call at any time to execute the mutation
 * - An object with fields that represent the current status of the mutation's execution
 *
 * @param baseOptions options that will be passed into the mutation, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options-2;
 *
 * @example
 * const [createOrRegenerateWatchTokenMutation, { data, loading, error }] = useCreateOrRegenerateWatchTokenMutation({
 *   variables: {
 *   },
 * });
 */
export function useCreateOrRegenerateWatchTokenMutation(baseOptions?: ApolloReactHooks.MutationHookOptions<CreateOrRegenerateWatchTokenMutation, CreateOrRegenerateWatchTokenMutationVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return ApolloReactHooks.useMutation<CreateOrRegenerateWatchTokenMutation, CreateOrRegenerateWatchTokenMutationVariables>(CreateOrRegenerateWatchTokenDocument, options);
      }
export type CreateOrRegenerateWatchTokenMutationHookResult = ReturnType<typeof useCreateOrRegenerateWatchTokenMutation>;
export type CreateOrRegenerateWatchTokenMutationResult = Apollo.MutationResult<CreateOrRegenerateWatchTokenMutation>;
export type CreateOrRegenerateWatchTokenMutationOptions = Apollo.BaseMutationOptions<CreateOrRegenerateWatchTokenMutation, CreateOrRegenerateWatchTokenMutationVariables>;
export const GetWatchTokenDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"query","name":{"kind":"Name","value":"GetWatchToken"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"getWatchToken"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"FragmentSpread","name":{"kind":"Name","value":"AccessTokenFragment"}}]}}]}},{"kind":"FragmentDefinition","name":{"kind":"Name","value":"AccessTokenFragment"},"typeCondition":{"kind":"NamedType","name":{"kind":"Name","value":"AccessTokenListDto"}},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"name"}},{"kind":"Field","name":{"kind":"Name","value":"expiresAt"}},{"kind":"Field","name":{"kind":"Name","value":"createdAt"}},{"kind":"Field","name":{"kind":"Name","value":"lastUsed"}},{"kind":"Field","name":{"kind":"Name","value":"isExpired"}},{"kind":"Field","name":{"kind":"Name","value":"token"}},{"kind":"Field","name":{"kind":"Name","value":"scopes"}}]}}]} as unknown as DocumentNode;

/**
 * __useGetWatchTokenQuery__
 *
 * To run a query within a React component, call `useGetWatchTokenQuery` and pass it any options that fit your needs.
 * When your component renders, `useGetWatchTokenQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useGetWatchTokenQuery({
 *   variables: {
 *   },
 * });
 */
export function useGetWatchTokenQuery(baseOptions?: ApolloReactHooks.QueryHookOptions<GetWatchTokenQuery, GetWatchTokenQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return ApolloReactHooks.useQuery<GetWatchTokenQuery, GetWatchTokenQueryVariables>(GetWatchTokenDocument, options);
      }
export function useGetWatchTokenLazyQuery(baseOptions?: ApolloReactHooks.LazyQueryHookOptions<GetWatchTokenQuery, GetWatchTokenQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return ApolloReactHooks.useLazyQuery<GetWatchTokenQuery, GetWatchTokenQueryVariables>(GetWatchTokenDocument, options);
        }
// @ts-ignore
export function useGetWatchTokenSuspenseQuery(baseOptions?: ApolloReactHooks.SuspenseQueryHookOptions<GetWatchTokenQuery, GetWatchTokenQueryVariables>): ApolloReactHooks.UseSuspenseQueryResult<GetWatchTokenQuery, GetWatchTokenQueryVariables>;
export function useGetWatchTokenSuspenseQuery(baseOptions?: ApolloReactHooks.SkipToken | ApolloReactHooks.SuspenseQueryHookOptions<GetWatchTokenQuery, GetWatchTokenQueryVariables>): ApolloReactHooks.UseSuspenseQueryResult<GetWatchTokenQuery | undefined, GetWatchTokenQueryVariables>;
export function useGetWatchTokenSuspenseQuery(baseOptions?: ApolloReactHooks.SkipToken | ApolloReactHooks.SuspenseQueryHookOptions<GetWatchTokenQuery, GetWatchTokenQueryVariables>) {
          const options = baseOptions === ApolloReactHooks.skipToken ? baseOptions : {...defaultOptions, ...baseOptions}
          return ApolloReactHooks.useSuspenseQuery<GetWatchTokenQuery, GetWatchTokenQueryVariables>(GetWatchTokenDocument, options);
        }
export type GetWatchTokenQueryHookResult = ReturnType<typeof useGetWatchTokenQuery>;
export type GetWatchTokenLazyQueryHookResult = ReturnType<typeof useGetWatchTokenLazyQuery>;
export type GetWatchTokenSuspenseQueryHookResult = ReturnType<typeof useGetWatchTokenSuspenseQuery>;
export type GetWatchTokenQueryResult = Apollo.QueryResult<GetWatchTokenQuery, GetWatchTokenQueryVariables>;
export const DeleteWatchTokenDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"mutation","name":{"kind":"Name","value":"DeleteWatchToken"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"deleteWatchToken"}}]}}]} as unknown as DocumentNode;
export type DeleteWatchTokenMutationFn = Apollo.MutationFunction<DeleteWatchTokenMutation, DeleteWatchTokenMutationVariables>;

/**
 * __useDeleteWatchTokenMutation__
 *
 * To run a mutation, you first call `useDeleteWatchTokenMutation` within a React component and pass it any options that fit your needs.
 * When your component renders, `useDeleteWatchTokenMutation` returns a tuple that includes:
 * - A mutate function that you can call at any time to execute the mutation
 * - An object with fields that represent the current status of the mutation's execution
 *
 * @param baseOptions options that will be passed into the mutation, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options-2;
 *
 * @example
 * const [deleteWatchTokenMutation, { data, loading, error }] = useDeleteWatchTokenMutation({
 *   variables: {
 *   },
 * });
 */
export function useDeleteWatchTokenMutation(baseOptions?: ApolloReactHooks.MutationHookOptions<DeleteWatchTokenMutation, DeleteWatchTokenMutationVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return ApolloReactHooks.useMutation<DeleteWatchTokenMutation, DeleteWatchTokenMutationVariables>(DeleteWatchTokenDocument, options);
      }
export type DeleteWatchTokenMutationHookResult = ReturnType<typeof useDeleteWatchTokenMutation>;
export type DeleteWatchTokenMutationResult = Apollo.MutationResult<DeleteWatchTokenMutation>;
export type DeleteWatchTokenMutationOptions = Apollo.BaseMutationOptions<DeleteWatchTokenMutation, DeleteWatchTokenMutationVariables>;
...
// @ts-ignore
export function useGetResourcePermissionsSuspenseQuery(baseOptions?: ApolloReactHooks.SuspenseQueryHookOptions<GetResourcePermissionsQuery, GetResourcePermissionsQueryVariables>): ApolloReactHooks.UseSuspenseQueryResult<GetResourcePermissionsQuery, GetResourcePermissionsQueryVariables>;
export function useGetResourcePermissionsSuspenseQuery(baseOptions?: ApolloReactHooks.SkipToken | ApolloReactHooks.SuspenseQueryHookOptions<GetResourcePermissionsQuery, GetResourcePermissionsQueryVariables>): ApolloReactHooks.UseSuspenseQueryResult<GetResourcePermissionsQuery | undefined, GetResourcePermissionsQueryVariables>;
...
// @ts-ignore
export function useAllOAuthProvidersSuspenseQuery(baseOptions?: ApolloReactHooks.SuspenseQueryHookOptions<AllOAuthProvidersQuery, AllOAuthProvidersQueryVariables>): ApolloReactHooks.UseSuspenseQueryResult<AllOAuthProvidersQuery, AllOAuthProvidersQueryVariables>;
export function useAllOAuthProvidersSuspenseQuery(baseOptions?: ApolloReactHooks.SkipToken | ApolloReactHooks.SuspenseQueryHookOptions<AllOAuthProvidersQuery, AllOAuthProvidersQueryVariables>): ApolloReactHooks.UseSuspenseQueryResult<AllOAuthProvidersQuery | undefined, AllOAuthProvidersQueryVariables>;
...
// @ts-ignore
export function useOAuthProviderSuspenseQuery(baseOptions?: ApolloReactHooks.SuspenseQueryHookOptions<OAuthProviderQuery, OAuthProviderQueryVariables>): ApolloReactHooks.UseSuspenseQueryResult<OAuthProviderQuery, OAuthProviderQueryVariables>;
export function useOAuthProviderSuspenseQuery(baseOptions?: ApolloReactHooks.SkipToken | ApolloReactHooks.SuspenseQueryHookOptions<OAuthProviderQuery, OAuthProviderQueryVariables>): ApolloReactHooks.UseSuspenseQueryResult<OAuthProviderQuery | undefined, OAuthProviderQueryVariables>;
...
// @ts-ignore
export function useHealthcheckSuspenseQuery(baseOptions?: ApolloReactHooks.SuspenseQueryHookOptions<HealthcheckQuery, HealthcheckQueryVariables>): ApolloReactHooks.UseSuspenseQueryResult<HealthcheckQuery, HealthcheckQueryVariables>;
export function useHealthcheckSuspenseQuery(baseOptions?: ApolloReactHooks.SkipToken | ApolloReactHooks.SuspenseQueryHookOptions<HealthcheckQuery, HealthcheckQueryVariables>): ApolloReactHooks.UseSuspenseQueryResult<HealthcheckQuery | undefined, HealthcheckQueryVariables>;
...
// @ts-ignore
export function useGetBackendVersionSuspenseQuery(baseOptions?: ApolloReactHooks.SuspenseQueryHookOptions<GetBackendVersionQuery, GetBackendVersionQueryVariables>): ApolloReactHooks.UseSuspenseQueryResult<GetBackendVersionQuery, GetBackendVersionQueryVariables>;
export function useGetBackendVersionSuspenseQuery(baseOptions?: ApolloReactHooks.SkipToken | ApolloReactHooks.SuspenseQueryHookOptions<GetBackendVersionQuery, GetBackendVersionQueryVariables>): ApolloReactHooks.UseSuspenseQueryResult<GetBackendVersionQuery | undefined, GetBackendVersionQueryVariables>;
...
// @ts-ignore
export function useGetNotificationServicesSuspenseQuery(baseOptions?: ApolloReactHooks.SuspenseQueryHookOptions<GetNotificationServicesQuery, GetNotificationServicesQueryVariables>): ApolloReactHooks.UseSuspenseQueryResult<GetNotificationServicesQuery, GetNotificationServicesQueryVariables>;
export function useGetNotificationServicesSuspenseQuery(baseOptions?: ApolloReactHooks.SkipToken | ApolloReactHooks.SuspenseQueryHookOptions<GetNotificationServicesQuery, GetNotificationServicesQueryVariables>): ApolloReactHooks.UseSuspenseQueryResult<GetNotificationServicesQuery | undefined, GetNotificationServicesQueryVariables>;
...
// @ts-ignore
export function useSystemAccessTokenRequestsSuspenseQuery(baseOptions?: ApolloReactHooks.SuspenseQueryHookOptions<SystemAccessTokenRequestsQuery, SystemAccessTokenRequestsQueryVariables>): ApolloReactHooks.UseSuspenseQueryResult<SystemAccessTokenRequestsQuery, SystemAccessTokenRequestsQueryVariables>;
export function useSystemAccessTokenRequestsSuspenseQuery(baseOptions?: ApolloReactHooks.SkipToken | ApolloReactHooks.SuspenseQueryHookOptions<SystemAccessTokenRequestsQuery, SystemAccessTokenRequestsQueryVariables>): ApolloReactHooks.UseSuspenseQueryResult<SystemAccessTokenRequestsQuery | undefined, SystemAccessTokenRequestsQueryVariables>;
...
// @ts-ignore
export function useMySystemAccessTokenRequestsSuspenseQuery(baseOptions?: ApolloReactHooks.SuspenseQueryHookOptions<MySystemAccessTokenRequestsQuery, MySystemAccessTokenRequestsQueryVariables>): ApolloReactHooks.UseSuspenseQueryResult<MySystemAccessTokenRequestsQuery, MySystemAccessTokenRequestsQueryVariables>;
export function useMySystemAccessTokenRequestsSuspenseQuery(baseOptions?: ApolloReactHooks.SkipToken | ApolloReactHooks.SuspenseQueryHookOptions<MySystemAccessTokenRequestsQuery, MySystemAccessTokenRequestsQueryVariables>): ApolloReactHooks.UseSuspenseQueryResult<MySystemAccessTokenRequestsQuery | undefined, MySystemAccessTokenRequestsQueryVariables>;
...
// @ts-ignore
export function useGetUserByIdSuspenseQuery(baseOptions?: ApolloReactHooks.SuspenseQueryHookOptions<GetUserByIdQuery, GetUserByIdQueryVariables>): ApolloReactHooks.UseSuspenseQueryResult<GetUserByIdQuery, GetUserByIdQueryVariables>;
export function useGetUserByIdSuspenseQuery(baseOptions?: ApolloReactHooks.SkipToken | ApolloReactHooks.SuspenseQueryHookOptions<GetUserByIdQuery, GetUserByIdQueryVariables>): ApolloReactHooks.UseSuspenseQueryResult<GetUserByIdQuery | undefined, GetUserByIdQueryVariables>;
...
// @ts-ignore
export function useGetSystemAccessTokensSuspenseQuery(baseOptions?: ApolloReactHooks.SuspenseQueryHookOptions<GetSystemAccessTokensQuery, GetSystemAccessTokensQueryVariables>): ApolloReactHooks.UseSuspenseQueryResult<GetSystemAccessTokensQuery, GetSystemAccessTokensQueryVariables>;
export function useGetSystemAccessTokensSuspenseQuery(baseOptions?: ApolloReactHooks.SkipToken | ApolloReactHooks.SuspenseQueryHookOptions<GetSystemAccessTokensQuery, GetSystemAccessTokensQueryVariables>): ApolloReactHooks.UseSuspenseQueryResult<GetSystemAccessTokensQuery | undefined, GetSystemAccessTokensQueryVariables>;
...
// @ts-ignore
export function useGetSystemTokenSuspenseQuery(baseOptions?: ApolloReactHooks.SuspenseQueryHookOptions<GetSystemTokenQuery, GetSystemTokenQueryVariables>): ApolloReactHooks.UseSuspenseQueryResult<GetSystemTokenQuery, GetSystemTokenQueryVariables>;
export function useGetSystemTokenSuspenseQuery(baseOptions?: ApolloReactHooks.SkipToken | ApolloReactHooks.SuspenseQueryHookOptions<GetSystemTokenQuery, GetSystemTokenQueryVariables>): ApolloReactHooks.UseSuspenseQueryResult<GetSystemTokenQuery | undefined, GetSystemTokenQueryVariables>;
...
// @ts-ignore
export function usePublicAppConfigSuspenseQuery(baseOptions?: ApolloReactHooks.SuspenseQueryHookOptions<PublicAppConfigQuery, PublicAppConfigQueryVariables>): ApolloReactHooks.UseSuspenseQueryResult<PublicAppConfigQuery, PublicAppConfigQueryVariables>;
export function usePublicAppConfigSuspenseQuery(baseOptions?: ApolloReactHooks.SkipToken | ApolloReactHooks.SuspenseQueryHookOptions<PublicAppConfigQuery, PublicAppConfigQueryVariables>): ApolloReactHooks.UseSuspenseQueryResult<PublicAppConfigQuery | undefined, PublicAppConfigQueryVariables>;
...
// @ts-ignore
export function useGetEventsPaginatedSuspenseQuery(baseOptions?: ApolloReactHooks.SuspenseQueryHookOptions<GetEventsPaginatedQuery, GetEventsPaginatedQueryVariables>): ApolloReactHooks.UseSuspenseQueryResult<GetEventsPaginatedQuery, GetEventsPaginatedQueryVariables>;
export function useGetEventsPaginatedSuspenseQuery(baseOptions?: ApolloReactHooks.SkipToken | ApolloReactHooks.SuspenseQueryHookOptions<GetEventsPaginatedQuery, GetEventsPaginatedQueryVariables>): ApolloReactHooks.UseSuspenseQueryResult<GetEventsPaginatedQuery | undefined, GetEventsPaginatedQueryVariables>;
...
// @ts-ignore
export function useUserNotificationStatsSuspenseQuery(baseOptions?: ApolloReactHooks.SuspenseQueryHookOptions<UserNotificationStatsQuery, UserNotificationStatsQueryVariables>): ApolloReactHooks.UseSuspenseQueryResult<UserNotificationStatsQuery, UserNotificationStatsQueryVariables>;
export function useUserNotificationStatsSuspenseQuery(baseOptions?: ApolloReactHooks.SkipToken | ApolloReactHooks.SuspenseQueryHookOptions<UserNotificationStatsQuery, UserNotificationStatsQueryVariables>): ApolloReactHooks.UseSuspenseQueryResult<UserNotificationStatsQuery | undefined, UserNotificationStatsQueryVariables>;
...
// @ts-ignore
export function useUserNotificationStatsByUserIdSuspenseQuery(baseOptions?: ApolloReactHooks.SuspenseQueryHookOptions<UserNotificationStatsByUserIdQuery, UserNotificationStatsByUserIdQueryVariables>): ApolloReactHooks.UseSuspenseQueryResult<UserNotificationStatsByUserIdQuery, UserNotificationStatsByUserIdQueryVariables>;
export function useUserNotificationStatsByUserIdSuspenseQuery(baseOptions?: ApolloReactHooks.SkipToken | ApolloReactHooks.SuspenseQueryHookOptions<UserNotificationStatsByUserIdQuery, UserNotificationStatsByUserIdQueryVariables>): ApolloReactHooks.UseSuspenseQueryResult<UserNotificationStatsByUserIdQuery | undefined, UserNotificationStatsByUserIdQueryVariables>;
...
// @ts-ignore
export function useGetPayloadMappersSuspenseQuery(baseOptions?: ApolloReactHooks.SuspenseQueryHookOptions<GetPayloadMappersQuery, GetPayloadMappersQueryVariables>): ApolloReactHooks.UseSuspenseQueryResult<GetPayloadMappersQuery, GetPayloadMappersQueryVariables>;
export function useGetPayloadMappersSuspenseQuery(baseOptions?: ApolloReactHooks.SkipToken | ApolloReactHooks.SuspenseQueryHookOptions<GetPayloadMappersQuery, GetPayloadMappersQueryVariables>): ApolloReactHooks.UseSuspenseQueryResult<GetPayloadMappersQuery | undefined, GetPayloadMappersQueryVariables>;
...
// @ts-ignore
export function useGetPayloadMapperSuspenseQuery(baseOptions?: ApolloReactHooks.SuspenseQueryHookOptions<GetPayloadMapperQuery, GetPayloadMapperQueryVariables>): ApolloReactHooks.UseSuspenseQueryResult<GetPayloadMapperQuery, GetPayloadMapperQueryVariables>;
export function useGetPayloadMapperSuspenseQuery(baseOptions?: ApolloReactHooks.SkipToken | ApolloReactHooks.SuspenseQueryHookOptions<GetPayloadMapperQuery, GetPayloadMapperQueryVariables>): ApolloReactHooks.UseSuspenseQueryResult<GetPayloadMapperQuery | undefined, GetPayloadMapperQueryVariables>;
...
// @ts-ignore
export function useGetEntityExecutionsSuspenseQuery(baseOptions?: ApolloReactHooks.SuspenseQueryHookOptions<GetEntityExecutionsQuery, GetEntityExecutionsQueryVariables>): ApolloReactHooks.UseSuspenseQueryResult<GetEntityExecutionsQuery, GetEntityExecutionsQueryVariables>;
export function useGetEntityExecutionsSuspenseQuery(baseOptions?: ApolloReactHooks.SkipToken | ApolloReactHooks.SuspenseQueryHookOptions<GetEntityExecutionsQuery, GetEntityExecutionsQueryVariables>): ApolloReactHooks.UseSuspenseQueryResult<GetEntityExecutionsQuery | undefined, GetEntityExecutionsQueryVariables>;
...
// @ts-ignore
export function useGetEntityExecutionSuspenseQuery(baseOptions?: ApolloReactHooks.SuspenseQueryHookOptions<GetEntityExecutionQuery, GetEntityExecutionQueryVariables>): ApolloReactHooks.UseSuspenseQueryResult<GetEntityExecutionQuery, GetEntityExecutionQueryVariables>;
export function useGetEntityExecutionSuspenseQuery(baseOptions?: ApolloReactHooks.SkipToken | ApolloReactHooks.SuspenseQueryHookOptions<GetEntityExecutionQuery, GetEntityExecutionQueryVariables>): ApolloReactHooks.UseSuspenseQueryResult<GetEntityExecutionQuery | undefined, GetEntityExecutionQueryVariables>;
...
// @ts-ignore
export function useGetServerSettingsSuspenseQuery(baseOptions?: ApolloReactHooks.SuspenseQueryHookOptions<GetServerSettingsQuery, GetServerSettingsQueryVariables>): ApolloReactHooks.UseSuspenseQueryResult<GetServerSettingsQuery, GetServerSettingsQueryVariables>;
export function useGetServerSettingsSuspenseQuery(baseOptions?: ApolloReactHooks.SkipToken | ApolloReactHooks.SuspenseQueryHookOptions<GetServerSettingsQuery, GetServerSettingsQueryVariables>): ApolloReactHooks.UseSuspenseQueryResult<GetServerSettingsQuery | undefined, GetServerSettingsQueryVariables>;
...
// @ts-ignore
export function useGetServerSettingSuspenseQuery(baseOptions?: ApolloReactHooks.SuspenseQueryHookOptions<GetServerSettingQuery, GetServerSettingQueryVariables>): ApolloReactHooks.UseSuspenseQueryResult<GetServerSettingQuery, GetServerSettingQueryVariables>;
export function useGetServerSettingSuspenseQuery(baseOptions?: ApolloReactHooks.SkipToken | ApolloReactHooks.SuspenseQueryHookOptions<GetServerSettingQuery, GetServerSettingQueryVariables>): ApolloReactHooks.UseSuspenseQueryResult<GetServerSettingQuery | undefined, GetServerSettingQueryVariables>;
...
// @ts-ignore
export function useGetServerLogsSuspenseQuery(baseOptions?: ApolloReactHooks.SuspenseQueryHookOptions<GetServerLogsQuery, GetServerLogsQueryVariables>): ApolloReactHooks.UseSuspenseQueryResult<GetServerLogsQuery, GetServerLogsQueryVariables>;
export function useGetServerLogsSuspenseQuery(baseOptions?: ApolloReactHooks.SkipToken | ApolloReactHooks.SuspenseQueryHookOptions<GetServerLogsQuery, GetServerLogsQueryVariables>): ApolloReactHooks.UseSuspenseQueryResult<GetServerLogsQuery | undefined, GetServerLogsQueryVariables>;
...
// @ts-ignore
export function useGetTotalLogCountSuspenseQuery(baseOptions?: ApolloReactHooks.SuspenseQueryHookOptions<GetTotalLogCountQuery, GetTotalLogCountQueryVariables>): ApolloReactHooks.UseSuspenseQueryResult<GetTotalLogCountQuery, GetTotalLogCountQueryVariables>;
export function useGetTotalLogCountSuspenseQuery(baseOptions?: ApolloReactHooks.SkipToken | ApolloReactHooks.SuspenseQueryHookOptions<GetTotalLogCountQuery, GetTotalLogCountQueryVariables>): ApolloReactHooks.UseSuspenseQueryResult<GetTotalLogCountQuery | undefined, GetTotalLogCountQueryVariables>;
...
// @ts-ignore
export function useGetUserLogsSuspenseQuery(baseOptions?: ApolloReactHooks.SuspenseQueryHookOptions<GetUserLogsQuery, GetUserLogsQueryVariables>): ApolloReactHooks.UseSuspenseQueryResult<GetUserLogsQuery, GetUserLogsQueryVariables>;
export function useGetUserLogsSuspenseQuery(baseOptions?: ApolloReactHooks.SkipToken | ApolloReactHooks.SuspenseQueryHookOptions<GetUserLogsQuery, GetUserLogsQueryVariables>): ApolloReactHooks.UseSuspenseQueryResult<GetUserLogsQuery | undefined, GetUserLogsQueryVariables>;
...
// @ts-ignore
export function useServerFilesSuspenseQuery(baseOptions?: ApolloReactHooks.SuspenseQueryHookOptions<ServerFilesQuery, ServerFilesQueryVariables>): ApolloReactHooks.UseSuspenseQueryResult<ServerFilesQuery, ServerFilesQueryVariables>;
export function useServerFilesSuspenseQuery(baseOptions?: ApolloReactHooks.SkipToken | ApolloReactHooks.SuspenseQueryHookOptions<ServerFilesQuery, ServerFilesQueryVariables>): ApolloReactHooks.UseSuspenseQueryResult<ServerFilesQuery | undefined, ServerFilesQueryVariables>;
...
// @ts-ignore
export function useAllServerFilesSuspenseQuery(baseOptions?: ApolloReactHooks.SuspenseQueryHookOptions<AllServerFilesQuery, AllServerFilesQueryVariables>): ApolloReactHooks.UseSuspenseQueryResult<AllServerFilesQuery, AllServerFilesQueryVariables>;
export function useAllServerFilesSuspenseQuery(baseOptions?: ApolloReactHooks.SkipToken | ApolloReactHooks.SuspenseQueryHookOptions<AllServerFilesQuery, AllServerFilesQueryVariables>): ApolloReactHooks.UseSuspenseQueryResult<AllServerFilesQuery | undefined, AllServerFilesQueryVariables>;
...
// @ts-ignore
export function useGetMyAdminSubscriptionsSuspenseQuery(baseOptions?: ApolloReactHooks.SuspenseQueryHookOptions<GetMyAdminSubscriptionsQuery, GetMyAdminSubscriptionsQueryVariables>): ApolloReactHooks.UseSuspenseQueryResult<GetMyAdminSubscriptionsQuery, GetMyAdminSubscriptionsQueryVariables>;
export function useGetMyAdminSubscriptionsSuspenseQuery(baseOptions?: ApolloReactHooks.SkipToken | ApolloReactHooks.SuspenseQueryHookOptions<GetMyAdminSubscriptionsQuery, GetMyAdminSubscriptionsQueryVariables>): ApolloReactHooks.UseSuspenseQueryResult<GetMyAdminSubscriptionsQuery | undefined, GetMyAdminSubscriptionsQueryVariables>;
...
// @ts-ignore
export function useUserAttachmentsSuspenseQuery(baseOptions?: ApolloReactHooks.SuspenseQueryHookOptions<UserAttachmentsQuery, UserAttachmentsQueryVariables>): ApolloReactHooks.UseSuspenseQueryResult<UserAttachmentsQuery, UserAttachmentsQueryVariables>;
export function useUserAttachmentsSuspenseQuery(baseOptions?: ApolloReactHooks.SkipToken | ApolloReactHooks.SuspenseQueryHookOptions<UserAttachmentsQuery, UserAttachmentsQueryVariables>): ApolloReactHooks.UseSuspenseQueryResult<UserAttachmentsQuery | undefined, UserAttachmentsQueryVariables>;
...
// @ts-ignore
export function useGetUserTemplatesSuspenseQuery(baseOptions?: ApolloReactHooks.SuspenseQueryHookOptions<GetUserTemplatesQuery, GetUserTemplatesQueryVariables>): ApolloReactHooks.UseSuspenseQueryResult<GetUserTemplatesQuery, GetUserTemplatesQueryVariables>;
export function useGetUserTemplatesSuspenseQuery(baseOptions?: ApolloReactHooks.SkipToken | ApolloReactHooks.SuspenseQueryHookOptions<GetUserTemplatesQuery, GetUserTemplatesQueryVariables>): ApolloReactHooks.UseSuspenseQueryResult<GetUserTemplatesQuery | undefined, GetUserTemplatesQueryVariables>;
...
// @ts-ignore
export function useGetUserTemplateSuspenseQuery(baseOptions?: ApolloReactHooks.SuspenseQueryHookOptions<GetUserTemplateQuery, GetUserTemplateQueryVariables>): ApolloReactHooks.UseSuspenseQueryResult<GetUserTemplateQuery, GetUserTemplateQueryVariables>;
export function useGetUserTemplateSuspenseQuery(baseOptions?: ApolloReactHooks.SkipToken | ApolloReactHooks.SuspenseQueryHookOptions<GetUserTemplateQuery, GetUserTemplateQueryVariables>): ApolloReactHooks.UseSuspenseQueryResult<GetUserTemplateQuery | undefined, GetUserTemplateQueryVariables>;
